...
\end{align}
\begin{figure}
\subfloat[Charachteristic curves given by \cref{eq:1a_charch_curve} with different starting conditions $x_0$.\label{fig:1aplot}]{\includegraphics[width=0.48\textwidth]{CharachteristicCurve_1a.pdf}}
\hfill
\subfloat[Charachteristic curves given by \cref{eq:1a_charch_curve} with different starting conditions $x_0$.\label{fig:1bplot}]{\includegraphics[width=0.48\textwidth]{CharachteristicCurve_1a.pdf}}
\end{figure}